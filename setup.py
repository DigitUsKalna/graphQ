...
setup(
  ...
  version = '1.0.1-beta',      # Start with a small number and increase it with every change you make
  ...
  download_url = 'https://github.com/d-kanti/graphQ/archive/1.0.1-beta.tar.gz',    # I explain this later on
